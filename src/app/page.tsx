...
const INGREDIENT_CARDS = [
  { name: "Fennel Seeds",      icon: "🌿", color: "#4a9e6b", benefit: "Aids Digestion",        desc: "Soothes the digestive tract, reduces bloating and supports gut health naturally." },
  ...
  { name: "Black Cardamom",    icon: "🫘", color: "#4a3a2a", benefit: "Respiratory Health",    desc: "Traditionally used to support respiratory health and ease congestion." },
  { name: "Star Anise",        icon: "⭐", color: "#c09020", benefit: "Anti-Viral Properties", desc: "Contains shikimic acid — a key compound used in antiviral medicines." },
  { name: "Mace",              icon: "🌺", color: "#d4720a", benefit: "Brain Function",        desc: "Supports cognitive function and memory with its natural active compounds." },
  { name: "Bay Leaves",        icon: "🍃", color: "#5a8a30", benefit: "Anti-Inflammatory",     desc: "Rich in compounds that reduce inflammation and support joint health." },
  { name: "Nigella Seeds",     icon: "🌚", color: "#6b4fa0", benefit: "Antioxidant Rich",      desc: "Packed with thymoquinone, a potent antioxidant that fights free radicals." },
  { name: "Ginger",            icon: "🫚", color: "#d4820a", benefit: "Warms & Energises",     desc: "Stimulates circulation, eases nausea and delivers a warming natural energy boost." },
];
