...
export const metadata: Metadata = {
  ...
  description: "Discover how Blackpool Brew supports gut health, mental clarity, immunity, mood and focus through 14 ancient herbs and spices.",
};
...
const BENEFITS = [
  {
    ...
    keyIngredients: ["Fennel Seeds", "Ginger", "Black Peppercorn", "White Peppercorn", "Green Cardamom"],
    mechanism: "Fennel Seeds are the gold standard for gut health — they relax the smooth muscles of the digestive tract to stop cramping and bloating. Ginger and both Peppercorns create thermogenesis, physically warming the stomach and stimulating the production of hydrochloric acid and enzymes needed to break down heavy proteins and fats.",
    benefit: "Better nutrient absorption, reduced bloating, and a calmer, more efficient digestive system.",
  ...
  },
  {
    ...
    keyIngredients: ["Star Anise", "Cloves", "Black Cumin Seeds", "Black Onion Seeds"],
    mechanism: "Star Anise contains Shikimic Acid — the primary precursor used globally to manufacture Tamiflu. It prevents viruses from budding and spreading between cells. Clove contains Eugenol, one of the most powerful natural antiseptics known. Black Cumin and Black Onion Seeds are both high in Thymoquinone, which modulates the immune system and helps fight respiratory infections.",
    benefit: "Resilience against seasonal illnesses, faster recovery times, and a stronger innate immune response.",
    compound: "Shikimic Acid (Star Anise) · Eugenol (Clove) · Thymoquinone (Black Cumin/Onion)",
  },
  {
    icon: "🧘",
    pillar: "Mood Support",
    ...
    mechanism: "Green Cardamom is known in Ayurveda as a cooling spice — it helps balance the heat of the peppers and acts as a mild antidepressant by clearing toxins that affect mood. Mace offers a gentle sedative effect on the nervous system, helping to manage anxiety and promote a sense of groundedness. When you pour boiling water, volatile terpenes from Cardamom and Bay Leaves are inhaled directly, reaching the limbic system before the liquid even touches your tongue.",
    benefit: "Reduced feelings of anxiety, a more stable emotional baseline, and a natural sense of calm.",
    compound: "Linalool (Cardamom) · Myristicin (Mace/Nutmeg) · Cineole (Bay Leaves)",
  },
  {
    icon: "⚡",
    pillar: "Focus & Energy",
...
export default function BenefitsPage() {
  return (
    <div className="page">
      ...
      <section className="section section--brew">
        <div className="section-inner">
          <div className="brew-note" style={{ marginBottom: "2rem" }}>
            ...
            <p>
              <strong>The Gut-Brain Axis:</strong> These five pillars are deeply interconnected. About 90% of your body&apos;s serotonin (the &ldquo;feel-good&rdquo; hormone) is produced in the gut. Improving Gut Health often leads to natural improvements in Mood Support and Mental Clarity — which is why a holistic blend like this is more effective than targeting a single system.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* ── Benefits ── */}
      {BENEFITS.map((b, i) => (
        <section key={b.pillar} className={`section ${i % 2 === 0 ? "section--why" : "section--possibilities"}`}>
          <div className="section-inner">
              ...
              <div className="benefit-block-body">
                <div className="benefit-text-col">
                  ...
                  <div className="brew-note">
                    <span className="brew-note-icon">✅</span>
                    <p><strong>Key Benefit:</strong> {b.benefit}</p>
                  </div>
                  <div className="benefit-compound-row">
                    <span className="benefit-compound-label">Active Compounds:</span>
                ...
                <div className="benefit-ing-col">
                  ...
                  <div className="benefit-ing-pills">
                    {b.keyIngredients.map((ing) => (
                      <span key={ing} className="hero-pill">{ing}</span>
                    ))}
                  </div>
                </div>
              </div>
        ...
        <div className="cta-banner">
          <div className="cta-banner-content">
            ...
            <p className="cta-banner-sub">
              The science is compelling. The taste is even better. Claim your free sample and experience all five benefits in a single cup.
            </p>
