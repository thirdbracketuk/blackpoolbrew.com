...
export const metadata: Metadata = {
  ...
  description: "Explore all 14 ingredients in Blackpool Brew — from Fennel Seeds to Ginger — and discover the unique wellness role each one plays.",
};

const INGREDIENTS = [
  {
    num: "01", name: "Fennel Seeds", icon: "🌿", color: "#4a9e6b",
    pillar: "Gut Health", compound: "Anethole",
  ...
  {
    num: "02", name: "Nutmeg", icon: "🟤", color: "#b88820",
    pillar: "Mental Clarity & Mood", compound: "Myristicin",
  ...
  {
    num: "03", name: "White Peppercorn", icon: "⚪", color: "#9a8a70",
    pillar: "Focus & Energy", compound: "Piperine",
  ...
  {
    num: "04", name: "Cinnamon", icon: "🪵", color: "#C04030",
    pillar: "Mental Clarity & Energy", compound: "Cinnamaldehyde",
  ...
  {
    num: "05", name: "Black Peppercorn", icon: "⚫", color: "#555",
    pillar: "Focus & Energy", compound: "Piperine",
  ...
  {
    num: "06", name: "Black Cumin Seeds", icon: "🌱", color: "#2a7a5a",
    pillar: "Immunity", compound: "Thymoquinone",
  ...
  {
    num: "07", name: "Cloves", icon: "🌰", color: "#8B3A62",
    pillar: "Immunity", compound: "Eugenol",
  ...
  {
    num: "08", name: "Green Cardamom", icon: "🫛", color: "#3a8a5a",
    pillar: "Mood & Gut Health", compound: "Linalool",
  ...
  {
    num: "09", name: "Star Anise", icon: "⭐", color: "#c09020",
    pillar: "Immunity", compound: "Shikimic Acid",
  ...
  {
    num: "10", name: "Mace", icon: "🌺", color: "#d4720a",
    pillar: "Mental Clarity & Mood", compound: "Myristicin",
  ...
  {
    num: "11", name: "Black Onion Seeds", icon: "🌚", color: "#6b4fa0",
    pillar: "Immunity & Detox", compound: "Thymoquinone",
  ...
  {
    num: "12", name: "Bay Leaves", icon: "🍃", color: "#5a8a30",
    pillar: "Energy & Gut Health", compound: "Cineole",
    role: "The Lung Herb",
  ...
  {
    num: "13", name: "Black Cardamom", icon: "🫘", color: "#4a3a2a",
    pillar: "Respiratory & Energy", compound: "Cineole",
  ...
  {
    num: "14", name: "Ginger", icon: "🫚", color: "#d4820a",
    pillar: "Gut Health & Energy", compound: "Gingerol",
  ...
  return (
    <div className="page">
      ...
      <section className="section section--brew">
        <div className="section-inner">
          <div className="section-header">
            ...
            <p className="section-sub">The 14 ingredients are arranged in a Fibonacci-like balance of actions — each tier supporting the others.</p>
          </div>
          <div className="brew-steps">
            {[
              { n: "I", title: "The Drivers", body: "Ginger, Black Pepper, White Pepper, Cinnamon — force blood flow and absorption, opening the cellular doors so every other ingredient can enter your bloodstream.", color: "#C04030" },
              { n: "II", title: "The Modulators", body: "Fennel, Nutmeg, Mace, Green Cardamom, Black Cardamom — balance the nervous system and gut, regulating mood, digestion and cognitive function.", color: "#4a9e6b" },
              { n: "III", title: "The Sentinels", body: "Star Anise, Clove, Black Cumin, Black Onion Seeds, Bay Leaves — protect against pathogens and cellular decay, your body's botanical defence system.", color: "#6b4fa0" },
            ].map((s) => (
              <div key={s.n} className="brew-step">
                <span className="brew-step-num" style={{ color: s.color }}>{s.n}</span>
      ...
      <section className="section section--why">
        <div className="section-inner">
          <div className="section-header">
            ...
            <p className="section-sub">Each ingredient, its active compound, and its unique role in the formulation.</p>
          </div>
          <div className="ing-full-grid">
            {INGREDIENTS.map((ing) => (
              <div key={ing.name} className="ing-full-card" style={{ "--ing-color": ing.color } as React.CSSProperties}>
                <div className="ing-full-card-top">
                  <span className="ing-full-num">{ing.num}</span>
                  <span className="ing-full-icon">{ing.icon}</span>
                  <span className="ing-full-tier" style={{ color: TIER_COLORS[ing.tier], borderColor: TIER_COLORS[ing.tier] + "40", background: TIER_COLORS[ing.tier] + "10" }}>{ing.tier}</span>
                </div>
                ...
                <div className="ing-full-meta">
                  ...
                  <span className="ing-full-compound">⚗️ {ing.compound}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="section section--possibilities">
        <div className="section-inner">
          <div className="section-header">
            ...
            <p className="section-sub">The inclusion of both types of pepper and both types of cardamom is intentional — for complete spectrum coverage.</p>
          </div>
          <div className="poss-grid">
            {[
              { icon: "⚫", title: "Black Peppercorn", body: "Full-bodied heat. Focuses on systemic inflammation and absorption throughout the entire body." },
              { icon: "⚪", title: "White Peppercorn", body: "Sharper, ferment-like heat. Focuses specifically on the upper digestive tract." },
              { icon: "🫘", title: "Black Cardamom", body: "Smoky, earthy. Better for respiratory health and deep detox via higher Cineole concentration." },
              { icon: "🫛", title: "Green Cardamom", body: "Sweet, floral. Better for cooling the stomach, freshening breath and mood support." },
            ].map((p, i) => (
        ...
        <div className="cta-banner">
          <div className="cta-banner-content">
            ...
            <p className="cta-banner-sub">
              14 ingredients. One extraordinary brew. Claim your free sample and experience the full-spectrum blend for yourself.
            </p>
      ...
      <div className="inner-page-nav">
        ...
        <Link href="/learn" className="inner-page-nav-link">How to Brew →</Link>
      </div>
